...
export default function Home() {
  ...
  const testimonials = [
    {
      id: '1',
      quote: '"To all the Staff at Watson House Care Home, thank you for taking care of my sister Joan S. Wishing you all the very best for the future "',
      author: 'Jean and Bob',
      role: 'Family Member, Watson House',
      initials: 'PM',
      rating: 5,
    },
    {
      id: '2',
      quote: '"To all of you, thank you for looking after my mum. "',
      author: 'Gary M.',
